...
class PreIrradianceIntegrator : public MonteCarloIntegrator<Float, Spectrum> {
public:
    ...
    PreIrradianceIntegrator(const Properties &props) : Base(props) { }
    ...
    std::string to_string() const override {
        return tfm::format("PreIrradianceIntegrator[\n"
            "  max_depth = %i,\n"
            "  rr_depth = %i\n"
...
MTS_IMPLEMENT_CLASS_VARIANT(PreIrradianceIntegrator, MonteCarloIntegrator)
MTS_EXPORT_PLUGIN(PreIrradianceIntegrator, "Precompute Irradiance integrator");
